...
urlpatterns = [
    ...
    path('check_small_payment/<str:issue_id>', views.check_small_payment, name='home'),
    path('add_small_payment/<str:issue_id>', views.add_small_payment, name='home'),
    path('add_student_id/<str:issue_id>', views.add_student_id, name='home'),
    path('add_client_manager/<str:issue_id>', views.add_client_manager, name='home'),
