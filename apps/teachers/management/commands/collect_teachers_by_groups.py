...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open("C:\\Logika\\logika_statistics\\apps\\teachers\\management\\commands\\Группы.csv", "r", encoding="utf-8") as f:
            ...
            for row in reader:
                ...
                # get teacher
                teacher_object = Teacher.objects.filter(full_name=group_teacher).first()
